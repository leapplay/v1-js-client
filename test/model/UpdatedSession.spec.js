...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LeapplayJsClient.UpdatedSession();
  });
  ...
  describe('UpdatedSession', function() {
    it('should create an instance of UpdatedSession', function() {
      // uncomment below and update the code to test UpdatedSession
      //var instance = new LeapplayJsClient.UpdatedSession();
      //expect(instance).to.be.a(LeapplayJsClient.UpdatedSession);
    });
