...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LeapplayJsClient.RequestChangePassword();
  });
  ...
  describe('RequestChangePassword', function() {
    it('should create an instance of RequestChangePassword', function() {
      // uncomment below and update the code to test RequestChangePassword
      //var instance = new LeapplayJsClient.RequestChangePassword();
      //expect(instance).to.be.a(LeapplayJsClient.RequestChangePassword);
    });
