...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LeapplayJsClient.CreatedSession();
  });
  ...
  describe('CreatedSession', function() {
    it('should create an instance of CreatedSession', function() {
      // uncomment below and update the code to test CreatedSession
      //var instance = new LeapplayJsClient.CreatedSession();
      //expect(instance).to.be.a(LeapplayJsClient.CreatedSession);
    });
