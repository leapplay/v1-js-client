...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LeapplayJsClient.StoppedSession();
  });
  ...
  describe('StoppedSession', function() {
    it('should create an instance of StoppedSession', function() {
      // uncomment below and update the code to test StoppedSession
      //var instance = new LeapplayJsClient.StoppedSession();
      //expect(instance).to.be.a(LeapplayJsClient.StoppedSession);
    });
